...
jobsKey = read.csv(paste0(FILE_PATH, '/', 'key_jobs.csv'), header = T, stringsAsFactors =  F)
peopleKey = read.csv(paste0(FILE_PATH, '/', 'key_people.csv'), header = T, stringsAsFactors = F)
#===================================================================='
